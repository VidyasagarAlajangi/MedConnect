...
const features = [
  ...
  },
  {
    ...
    description:
      "Secure messaging system with digital prescriptions for seamless healthcare.",
    details:
      "Enjoy crystal-clear video consultations with your doctor, ensuring effective and secure communication from the comfort of your home.",
    icon: <Video className="w-12 h-12 text-[#4a90e2]" />,
  },
  {
